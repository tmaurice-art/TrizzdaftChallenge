...
#| label: dag-1-1747
#| echo: true
#| fig-cap: "DAG 1: 1747 Understanding — Lemons prevent scurvy (correct but incomplete)"
...
#| echo: true
#| fig-cap: "DAG 2: Misguided belief — Acid → Bacteria death → Scurvy prevention (incorrect)"

import daft

# Create a DAG showing the misguided belief: Acid → Bacteria Death → Scurvy Prevention
# Use amber/coral styling to indicate this is the wrong understanding
pgm = daft.PGM(dpi=150, alternate_style="outer")

# Acid node (incorrectly believed cause)
pgm.add_node("acid", "Acid", 1, 1, aspect=2.5, scale=1.1,
             plot_params={
                 "facecolor": "mistyrose",
                 "edgecolor": "coral",
                 "linewidth": 2,
...
# Bacteria death node (incorrect mechanism)
pgm.add_node("bacteria_death", "Bacteria\nDeath", 2.5, 1, aspect=2.5, scale=1.1,
             plot_params={
...
# Scurvy prevention node (effect)
pgm.add_node("scurvy_prevention", "Scurvy\nPrevention", 4, 1, aspect=2.5, scale=1.1,
             plot_params={
                 "facecolor": "lightyellow",
                 "edgecolor": "darkgoldenrod",
                 "linewidth": 2,
...
#| label: dag-3-1928
#| echo: true
#| fig-cap: "DAG 3: 1928 Understanding — Vitamin C prevents scurvy (complete and correct)"

import daft

# Create a DAG showing the 1928 understanding: Vitamin C → Collagen Synthesis → Scurvy Prevention
pgm = daft.PGM(dpi=150, alternate_style="outer")

# Vitamin C node (true cause)
pgm.add_node("vitamin_c", "Vitamin C", 1, 1, aspect = 2.5, scale = 1.1,
             plot_params={
                 'facecolor': 'lightcyan',
                 'edgecolor': 'teal',
                 'linewidth': 2,
...
# Collagen synthesis node (mechanism)
pgm.add_node("collagen_synthesis", "Collagen\nSynthesis", 2.5, 1, aspect = 2.5, scale = 1.1,
             plot_params={
                 'facecolor': 'lightyellow',
                 'edgecolor': 'goldenrod',
                 'linewidth': 2,
